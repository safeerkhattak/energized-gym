...
//   return (
//     <div className="min-h-screen flex flex-col bg-gradient-to-br from-white to-gray-100 dark:from-black dark:to-gray-900">
//       {/* Header / Logo */}
//       <header className="w-full flex justify-center py-8">
//         <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-blue-700 dark:text-blue-400 drop-shadow-lg">
//           Energized Fitness
//         </h1>
//       </header>

//       {/* Hero Section with Main Image */}
//       <section className="flex flex-col-reverse md:flex-row items-center justify-between max-w-5xl mx-auto px-4 py-8 gap-8 flex-1">
//         <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left gap-6">
//           <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white">
//             Join the Energy. <span className="text-blue-600 dark:text-blue-400">Transform Your Life.</span>
//           </h2>
//           <p className="text-lg text-gray-700 dark:text-gray-300 max-w-md">
//             Welcome to Energized Fitness, your local destination for modern equipment, expert trainers, and a vibrant community. Start your fitness journey today!
//           </p>
//           <a
//             href="#contact"
//             className="mt-2 inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-full shadow-lg transition-colors"
//           >
//             Book a Free Trial
//           </a>
//         </div>
//         <div className="flex-1 flex justify-center">
//           <div className="relative w-[320px] h-[320px] rounded-3xl overflow-hidden shadow-2xl border-4 border-blue-100 dark:border-blue-900">
//             <Image
//               src="/img/Reception Gym_1.png"
//               alt="Reception area of Energized Fitness"
//               fill
//               style={{objectFit: 'cover'}}
//               priority
//             />
//             <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
//               <span className="text-white font-semibold text-lg">Reception Area</span>
//             </div>
//           </div>
//         </div>
//       </section>
...
//         <div className="flex flex-col items-center text-center gap-3 bg-white/80 dark:bg-gray-800/80 rounded-2xl shadow-lg p-4">
//           <div className="relative w-full h-40 rounded-xl overflow-hidden mb-2">
//             <Image src="/img/gym area_1.png" alt="Gym Area" fill style={{objectFit: 'cover'}} />
//           </div>
//           <h3 className="font-bold text-lg text-gray-900 dark:text-white">Modern Gym Area</h3>
//           <p className="text-gray-600 dark:text-gray-300 text-sm">State-of-the-art machines and free weights for every workout style.</p>
//         </div>
//         <div className="flex flex-col items-center text-center gap-3 bg-white/80 dark:bg-gray-800/80 rounded-2xl shadow-lg p-4">
//           <div className="relative w-full h-40 rounded-xl overflow-hidden mb-2">
//             <Image src="/img/workout Area_1.png" alt="Workout Area" fill style={{objectFit: 'cover'}} />
//           </div>
//           <h3 className="font-bold text-lg text-gray-900 dark:text-white">Workout Area</h3>
//           <p className="text-gray-600 dark:text-gray-300 text-sm">Spacious workout zones for group classes and personal training.</p>
//         </div>
//         <div className="flex flex-col items-center text-center gap-3 bg-white/80 dark:bg-gray-800/80 rounded-2xl shadow-lg p-4">
//           <div className="relative w-full h-40 rounded-xl overflow-hidden mb-2">
//             <Image src="/img/Reception Gym_1.png" alt="Reception Area" fill style={{objectFit: 'cover'}} />
//           </div>
//           <h3 className="font-bold text-lg text-gray-900 dark:text-white">Welcoming Reception</h3>
//           <p className="text-gray-600 dark:text-gray-300 text-sm">Friendly staff to greet and assist you every step of the way.</p>
//         </div>
//       </section>

//       {/* Footer */}
//       <footer className="w-full py-6 flex flex-col items-center gap-2 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 mt-auto">
//         <span className="text-gray-500 text-sm">&copy; {new Date().getFullYear()} Energized Fitness. All rights reserved.</span>
//         <a
//           id="contact"
//           href="mailto:info@energizedfitness.com"
//           className="text-blue-600 hover:underline text-sm"
//         >
//           info@energizedfitness.com
//         </a>
//       </footer>
//     </div>
//   );
